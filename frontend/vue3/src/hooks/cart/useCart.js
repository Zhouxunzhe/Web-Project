...
export default function useCart() {
  ...
  // 更新购物车仲的商品数量
  const changeGoodsCountOfCartBySkuId = ({ id, count }) => {
    console.log("changeGoodsCountOfCartBySkuId");
    console.log({ id, count }, false);
    store.dispatch("cart/updateGoodsOfCartBySkuId", { good_id: id, selected:true, count, is_check:false });
  };
