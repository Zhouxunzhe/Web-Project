    ...
    <div class="xtx-goods-page">
      <div class="container" v-if="goodsDetail">
        ...
        <div class="goods-info">
          <!-- 左侧 -->
          <div class="media">
            <GoodsImages :images="goodsDetail.images" />
            <GoodsSales />
          </div>
          <!-- 右侧 -->
          <div class="spec">
...
export default {
  ...
  setup() {
    const { result: goodsDetail, onSpecChange, count, addCart, gotoOrder } = useGoods();
    // 通过provide 注入goodsDetail数据
    provide("goodsDetail", goodsDetail);

    return { goodsDetail, onSpecChange, count, addCart, gotoOrder };
  },
};
</script>
